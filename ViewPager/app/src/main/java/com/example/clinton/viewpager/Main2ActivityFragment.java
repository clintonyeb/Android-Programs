package com.example.clinton.viewpager;
...
public class Main2ActivityFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mContentView = getActivity().findViewById(R.id.fullscreen_content);
        ...
        getActivity().findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
    }
