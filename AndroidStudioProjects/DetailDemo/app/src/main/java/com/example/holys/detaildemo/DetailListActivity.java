package com.example.holys.detaildemo;
...
import com.example.holys.detaildemo.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick (View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DetailDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        Intent intent = new Intent(context, DetailDetailActivity.class);
                        intent.putExtra(DetailDetailFragment.ARG_ITEM_ID, holder.mItem.id);
